...
df_players.loc[df_players.NAME == 'Kiko Alonzo','p-DUPR'] = 4.0
df_players.loc[df_players.NAME == 'Gary Keck','p-DUPR'] = 3.5
players = list(df_players.NAME)


dr={'M':{},'G':{},'P':{}}

#grecord = game # + result (3W,2L), spreads = PF-PA, partnerdupr = partner provisional, opponentdupr = avg both opponents
d_stats={'grecord':{},'spread':{},'p_dupr':{},'o_dupr':{}}
